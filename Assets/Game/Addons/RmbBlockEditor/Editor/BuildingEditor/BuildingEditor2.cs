...
{
    public class BuildingEditor2 : VisualElement
    {
        private const string WorldDataFolder = "/StreamingAssets/WorldData/";
        private readonly Building building;

        public BuildingEditor2(Building building)
        {
        ...
        private void SetupTemplate()
        {
            var template =
                AssetDatabase.LoadAssetAtPath<VisualTreeAsset>(
                    "Assets/Game/Addons/RmbBlockEditor/Editor/BuildingEditor/Template2.uxml");
